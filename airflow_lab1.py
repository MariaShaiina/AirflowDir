...
def extract_transform_load_data():
    chunks = [pd.read_csv(f"/home/masha/Prerequisites/airflow/data/lab_1/input/chunk{i}.csv") for i in range(26)]
    ...
    result_dataframe.to_csv('/home/masha/Prerequisites/airflow/data/lab_1/output/data.csv', index=False)
...
def load_chunck_data_to_elastic():
    ...
    data_from_file = pd.read_csv('/home/masha/Prerequisites/airflow/data/lab_1/output/data.csv')
